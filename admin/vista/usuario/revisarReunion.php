    ...
    <section>
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                <form id="formulario01" method="POST" action="../../controlador/usuario/eliminar.php">
                    ...
                    <input type="text" id="destinatario" name="destinatarios" value="<?php echo $row["reunion_destinatario"]; ?>" disabled />
                    <br>
                    
                    <label for="fecha">Fecha (*)</label>
                    <input type="date" id="fecha" name="fecha" value="<?php echo $row["reunion_fecha"]; ?>" disabled />
                    <br>
